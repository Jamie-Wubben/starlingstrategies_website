          ...
          <div className="grid md:grid-cols-2 gap-8 mt-12">
            ...
            <Link href={`/${locale}/services`} className="group relative p-8 rounded-2xl bg-gray-900/50 border border-gray-800 hover:border-primary/50 transition-all duration-300 hover:shadow-2xl hover:shadow-primary/10 text-left block">
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-2xl font-bold mb-4 text-white group-hover:text-primary transition-colors">{t('fork.business.title')}</h3>
                <p className="text-gray-400 mb-6">{t('fork.business.text')}</p>
                <span className="text-primary font-medium flex items-center gap-2 group-hover:gap-3 transition-all">
                  {t('fork.business.cta')} <span aria-hidden="true">&rarr;</span>
                </span>
              </div>
            </Link>
            ...
            <Link href={`/${locale}/services`} className="group relative p-8 rounded-2xl bg-gray-900/50 border border-gray-800 hover:border-secondary/50 transition-all duration-300 hover:shadow-2xl hover:shadow-secondary/10 text-left block">
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-2xl font-bold mb-4 text-white group-hover:text-secondary transition-colors">{t('fork.tech.title')}</h3>
                <p className="text-gray-400 mb-6">{t('fork.tech.text')}</p>
                <span className="text-secondary font-medium flex items-center gap-2 group-hover:gap-3 transition-all">
                  {t('fork.tech.cta')} <span aria-hidden="true">&rarr;</span>
                </span>
              </div>
            </Link>
          </div>
