...
export default async function ServicesPage({
    ...
    return (
        <div className="min-h-screen py-20 px-4 max-w-5xl mx-auto space-y-24">
            ...
            <div id="website-development" className="scroll-mt-32 group relative p-8 md:p-12 rounded-2xl bg-gray-900/50 border border-gray-800 hover:border-[#f97316]/50 transition-all duration-300 hover:shadow-2xl hover:shadow-[#f97316]/10">
            ...
            <div id="ai-automation" className="scroll-mt-32 group relative p-8 md:p-12 rounded-2xl bg-gray-900/50 border border-gray-800 hover:border-primary/50 transition-all duration-300 hover:shadow-2xl hover:shadow-primary/10">
            ...
            <div id="rd-consulting" className="scroll-mt-32 group relative p-8 md:p-12 rounded-2xl bg-gray-900/50 border border-gray-800 hover:border-secondary/50 transition-all duration-300 hover:shadow-2xl hover:shadow-secondary/10">
